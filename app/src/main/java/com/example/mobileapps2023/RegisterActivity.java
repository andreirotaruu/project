        ...
        ButtonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editTextRegisterFirstName.requestFocus();
                    ...
                    Toast.makeText(RegisterActivity.this, "Please enter your password longer than 6 characters", Toast.LENGTH_SHORT).show();
            ...
            private void registerUser(String textEmail, String textFname, String textPassword, String textLname) {
        ...
        imageViewShowHidePwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editTextRegisterPwd.getTransformationMethod().equals(HideReturnsTransformationMethod.getInstance())) {
                    ...
                    editTextRegisterEmail.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
